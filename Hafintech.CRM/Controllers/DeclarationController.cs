...
namespace Hafintech.CRM.Controllers
{
    public class DeclarationController : Controller
    {
        ...
        public ActionResult Commodity_List(long decID = 0, int uid = 0)
        {
            ViewBag.uid = uid;
            ViewBag.declarationID = decID;
            return View();
        ...
        public ActionResult CommodityHighValue_List(long decID = 0, int uid = 0)
        {
            ViewBag.declarationID = decID;
            return View();
        }
