! function (c) {
    ...
    function a() {
        var g = new Date();
        return f(g.getFullYear(), g.getMonth(), g.getDate(), g.getHours(), g.getMinutes(), g.getSeconds(), 0)
    }
    var e = function (h, g) {
        var i = this;
        this.element = c(h);
    ...
    e.prototype = {
        ...
        setDate: function (g) {
            this.setDate(new Date(g.getTime() - (g.getTimezoneOffset() * 60000)))
        },
        setDate: function (g) {
        ...
        fill: function () {
            ...
            var E = new Date(this.viewDate),
                ...
                z = E.getHours(),
                u = E.getMinutes(),
                v = this.startDate !== -Infinity ? this.startDate.getFullYear() : -Infinity,
                A = this.startDate !== -Infinity ? this.startDate.getMonth() : -Infinity,
                l = this.endDate !== Infinity ? this.endDate.getFullYear() : Infinity,
                w = this.endDate !== Infinity ? this.endDate.getMonth() : Infinity,
                n = (new f(this.date.getFullYear(), this.date.getMonth(), this.date.getDate())).valueOf(),
                D = new Date();
            ...
            var I = f(q, F - 1, 28, 0, 0, 0, 0),
                y = b.getDaysInMonth(I.getFullYear(), I.getMonth());
            I.setDate(y);
            I.setDate(y - (I.getDay() - this.weekStart + 7) % 7);
            var g = new Date(I);
            g.setDate(g.getDate() + 42);
            g = g.valueOf();
            var o = [];
            var r;
            while (I.valueOf() < g) {
                ...
                r = "";
                if (I.getFullYear() < q || (I.getFullYear() == q && I.getMonth() < F)) {
                    r += " old"
                } else {
                    if (I.getFullYear() > q || (I.getFullYear() == q && I.getMonth() > F)) {
                        r += " new"
                ...
                if (this.todayHighlight && I.getFullYear() == D.getFullYear() && I.getMonth() == D.getMonth() && I.getDate() == D.getDate()) {
                    r += " today"
                }
                if (I.valueOf() == n) {
                    r += " active"
                }
                if ((I.valueOf() + 86400000) <= this.startDate || I.valueOf() > this.endDate || c.inArray(I.getDay(), this.daysOfWeekDisabled) !== -1) {
                    r += " disabled"
                }
                o.push('<td class="day' + r + '">' + I.getDate() + "</td>");
        ...
        updateNavArrows: function () {
            ...
            switch (this.viewMode) {
                case 0:
                    if (this.startDate !== -Infinity && i <= this.startDate.getFullYear() && j <= this.startDate.getMonth() && h <= this.startDate.getDate() && g <= this.startDate.getHours()) {
                    ...
                    if (this.endDate !== Infinity && i >= this.endDate.getFullYear() && j >= this.endDate.getMonth() && h >= this.endDate.getDate() && g >= this.endDate.getHours()) {
                    ...
                    break;
                case 1:
                    if (this.startDate !== -Infinity && i <= this.startDate.getFullYear() && j <= this.startDate.getMonth() && h <= this.startDate.getDate()) {
                        this.picker.find(".prev").css({
                            visibility: "hidden"
                        })
                    } else {
                    ...
                    if (this.endDate !== Infinity && i >= this.endDate.getFullYear() && j >= this.endDate.getMonth() && h >= this.endDate.getDate()) {
                        this.picker.find(".next").css({
                            visibility: "hidden"
                        })
                    } else {
                    ...
                    break;
                case 2:
                    if (this.startDate !== -Infinity && i <= this.startDate.getFullYear() && j <= this.startDate.getMonth()) {
                        this.picker.find(".prev").css({
                            visibility: "hidden"
                        })
                    } else {
                    ...
                    if (this.endDate !== Infinity && i >= this.endDate.getFullYear() && j >= this.endDate.getMonth()) {
                        this.picker.find(".next").css({
                            visibility: "hidden"
                        })
                    } else {
                ...
                case 3:
                case 4:
                    if (this.startDate !== -Infinity && i <= this.startDate.getFullYear()) {
                        this.picker.find(".prev").css({
                            visibility: "hidden"
                        })
                    } else {
                    ...
                    if (this.endDate !== Infinity && i >= this.endDate.getFullYear()) {
                        this.picker.find(".next").css({
                            visibility: "hidden"
                        })
                    } else {
                    ...
                    case "span":
                        if (!l.is(".disabled")) {
                            var n = this.viewDate.getFullYear(),
                                ...
                                o = this.viewDate.getDate(),
                                p = this.viewDate.getHours(),
                                i = this.viewDate.getMinutes(),
                                q = this.viewDate.getSeconds();
                            if (l.is(".month")) {
        ...
        moveMinute: function (h, g) {
            ...
            i.setMinutes(i.getMinutes() + (g * this.minuteStep));
            return i
        },
    ...
    var b = {
        ...
        parseDate: function (l, u, o, r) {
            ...
            if (/^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(l)) {
                ...
                return f(l.getFullYear(), l.getMonth(), l.getDate(), l.getHours(), l.getMinutes(), l.getSeconds(), 0)
            }
            var m = l && l.match(this.nonpunctuation) || [],
                ...
                v = {
                    ...
                    yyyy: function (s, i) {
                        return s.setFullYear(i)
                    },
                    yy: function (s, i) {
                        return s.setFullYear(2000 + i)
                    },
                    m: function (s, i) {
                        i -= 1;
                        while (i < 0) {
                    ...
                    p: function (s, i) {
                        return s.setHours(i == 1 ? s.getHours() + 12 : s.getHours())
                    }
                },
                j, p, g;
            v.M = v.MM = v.mm = v.m;
        ...
        formatDate: function (g, m, o, k) {
            ...
            if (k == "standard") {
                n = {
                    ...
                    yyyy: g.getFullYear(),
                    m: g.getMonth() + 1,
                    M: d[o].monthsShort[g.getMonth()],
                    MM: d[o].months[g.getMonth()],
                    d: g.getDate(),
                    D: d[o].daysShort[g.getDay()],
                    DD: d[o].days[g.getDay()],
                    p: (d[o].meridiem.length == 2 ? d[o].meridiem[g.getHours() < 12 ? 0 : 1] : ""),
                    h: g.getHours(),
                    i: g.getMinutes(),
                    s: g.getSeconds()
                };
                ...
                if (k == "php") {
                    n = {
                        y: g.getFullYear().toString().substring(2),
                        Y: g.getFullYear(),
                        F: d[o].months[g.getMonth()],
                        M: d[o].monthsShort[g.getMonth()],
                        n: g.getMonth() + 1,
                        t: b.getDaysInMonth(g.getFullYear(), g.getMonth()),
                        j: g.getDate(),
                        l: d[o].days[g.getDay()],
                        D: d[o].daysShort[g.getDay()],
                        w: g.getDay(),
                        N: (g.getDay() == 0 ? 7 : g.getDay()),
                        S: (g.getDate() % 10 <= d[o].suffix.length ? d[o].suffix[g.getDate() % 10 - 1] : ""),
                        a: (d[o].meridiem.length == 2 ? d[o].meridiem[g.getHours() < 12 ? 0 : 1] : ""),
                        g: (g.getHours() % 12 == 0 ? 12 : g.getHours() % 12),
                        G: g.getHours(),
                        i: g.getMinutes(),
                        s: g.getSeconds()
                    };
