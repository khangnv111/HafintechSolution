var Lib = new function () {
	...
	// Phân loại cá nhân tổ chức
	this.getLoadingLocation = async function (name, code) {
		try {
			var token = $('#hdfToken').val();
			const response = await axios.get(Config.API_Login + "tax/getLoadingLocation",
				{
					params: {
						loadLocCd: name,
						loadLocNm: code,
	...
	//chi cuc hai quan
	this.getCustomsOffice = async function (cstOfficeCd, cstOfficeNm, cstDepartment) {
		try {
			var token = $('#hdfToken').val();
			if (cstOfficeCd == undefined || cstOfficeCd == null) cstOfficeCd = "";
			if (cstOfficeNm == undefined || cstOfficeNm == null) cstOfficeNm = "";
			if (!cstDepartment) cstDepartment = "";

			const response = await axios.get(Config.API_Login + "tax/GetCustomsOffice?cstOfficeCd=" + cstOfficeCd + "&cstOfficeNm=" + cstOfficeNm + "&cstDepartment=" + cstDepartment,
				{
					headers: { "Authorization": "Bearer " + token }
				});
			var res = response.data;
	...
	//Cuc hai quan
	this.GetCustomsDepartment = async function () {
		try {
			var token = $('#hdfToken').val();
			const response = await axios.get(Config.API_Login + "tax/GetCustomsDepartment",
				{
					headers: { "Authorization": "Bearer " + token }
				});
			var res = response.data;
	...
	this.getDeclarationKind = async function (dclKindCd) {
		try {
			var token = $('#hdfToken').val();
			if (!dclKindCd) dclKindCd = "";
			const response = await axios.get(Config.API_Login + "tax/GetDeclarationKind?dclKindCd=" + dclKindCd,
				{
					headers: { "Authorization": "Bearer " + token }
				});
			var res = response.data;
	...
	this.GetInfoByAccountID = async function (id) {
		try {
			var token = $('#hdfToken').val();
			const response = await axios.get(Config.API_Login + "account/GetInfoByAccountID?accountID=" + id,
				{
					headers: { "Authorization": "Bearer " + token }
				});
			var res = response.data;
	...
	//================Trung tâm soi chiếu================
	//Trạng thái soi chiếu
	this.ListScannerDictionary = async function (code) {
		try {
			var token = $('#hdfToken').val();
			const response = await axios.get(Config.API_Login + "agency/GetListDictionary?code=" + code,
				{
					headers: { "Authorization": "Bearer " + token }
				});
			var res = response.data;
