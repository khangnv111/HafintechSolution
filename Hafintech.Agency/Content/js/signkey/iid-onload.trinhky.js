                        ...
                        if (wscpp.vData.length >= 2) {
                            ...
                            xhttp.onreadystatechange = function () {
                                ...
                                if (this.readyState == 4 && this.status == 200) {
                                    //document.getElementById("txtResult").value = xhttp.responseText;
                                    ...
                                    if (ress.ResponseCode > 0) {
                                        bootbox.alert("Thành công!", function () {
                                            ...
                                            if (ishight == "1") {
                                                window.location.href = Config.Url_Root + "declaration/LowValueDeInsert?IdDec=" + ress.Data.dclId + "&ishight=1&tab=4";
                                            }
                                            else {
                                                window.location.href = Config.Url_Root + "declaration/HightValueDeInsert?IdDec=" + ress.Data.dclId + "&ishight=2&tab=7";
                                            }
                                        });
                                    } 
                                    else {
